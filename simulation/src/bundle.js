...
const stockLists = __webpack_require__(8);
const traderLists = __webpack_require__(9);
const initialAssetLists = __webpack_require__(10);
...
const traderLists = {
  ...
  '1': [
    ['Bill',   [0.1, -3, -2, -2.5, 1.05, 1.05], 1], 
    ['Hillary',  [0.2, -2, -3, -3.5, 1.05, 1.05], 1], 
    ['Chelsea', [0.3, -1, -1, -1.5, 1.05, 1.05], 1], 
    ['Curly', [0.2, -6, -4, -4.5, 1.05, 1.05], 0.5], 
    ['Moe',   [0.4, -4, -6, -6.5, 1.05, 1.05], 0.5], 
    ['Larry', [0.6, -2, -2, -2.5, 1.05, 1.05], 0.5], 
    ['Groucho', [0.05, -1.5, -1, -1.5, 1.05, 1.05], 0.75], 
    ['Harpo', [0.1, -1, -1.5, -2.0, 1.05, 1.05], 0.75], 
    ['Zeppo', [0.15, -0.5, -0.5, -1.0, 1.05, 1.05], 0.75], 
    ['Jermaine', [0.25, -2.5, -5, -5.5, 1.05, 1.05], 1], 
    ['Marlon', [0.35, -1.5, -3, -3.5, 1.05, 1.05], 1], 
    ['Tito', [0.25, -6.5, -6, -6.5, 1.05, 1.05], 0.5], 
    ['Michael', [0.45, -4.5, -8, -8.5, 1.05, 1.05], 0.5], 
    ['Randy', [0.65, -2.5, -4, -4.5, 1.05, 1.05], 0.5], 
    ['Jackie', [0.55, -2.0, -3, -3.5, 1.05, 1.05], 0.75], 
    ...
    ['Robin', [0.15, -1.5, -3.5, -4.0, 1.05, 1.05], 0.75], 
    ['Maurice', [0.55, -1.5, -2.5, -3.0, 1.05, 1.05], 0.75],
    ['Donald', [1.0, -1.0, -5, -5.5, 1.05, 1.05], 0.25],
    ['Ivana', [2.0, -2.0, -2, -2.5, 1.05, 1.05], 0.5],
    ['Donald Jr', [1.0, -1.0, -7.0, -7.5, 1.05, 1.05], 0.3],
    ['Eric', [1.0, -1.0, -5, -5.5, 1.05, 1.05], 0.25],
    ['Ivanka', [2.0, -2.0, -2, -2.5, 1.05, 1.05], 0.1],
    ['Jared', [3.0, -3.0, -2, -2.5, 1.05, 1.05], 0.2],
    ['Marla', [3.0, -3.0, -1, -1.5, 1.05, 1.05], 0.5],
    ['Tiffany', [2.0, -2.0, -1, -1.5, 1.05, 1.05], 0.5],
    ['Melania', [1.0, -1.0, -1, -1.5, 1.05, 1.05], 0.5],
    ['Barron', [1.0, -1.0, -1, -1.5, 1.05, 1.05], 0.5],
    ['Index', [0, 0, -1.0, -1, -1, 1.05, 1.05], 1],
  ],
  '2': [
    ['Bill',   [0.1, -3, -2, -2.5, 1.05, 1.05], 1, 20], 
    ['Hillary',  [0.2, -2, -3, -3.5, 1.05, 1.05], 1, 20], 
    ['Chelsea', [0.3, -1, -1, -1.5, 1.05, 1.05], 1, 20], 
    ['Curly', [0.2, -6, -4, -4.5, 1.05, 1.05], 0.5, 20], 
    ['Moe',   [0.4, -4, -6, -6.5, 1.05, 1.05], 0.5, 20], 
    ['Larry', [0.6, -2, -2, -2.5, 1.05, 1.05], 0.5, 20], 
    ['Groucho', [0.05, -1.5, -1, -1.5, 1.05, 1.05], 0.75, 20], 
    ['Harpo', [0.1, -1, -1.5, -2.0, 1.05, 1.05], 0.75, 20], 
    ['Zeppo', [0.15, -0.5, -0.5, -1.0, 1.05, 1.05], 0.75, 20], 
    ['Jermaine', [0.25, -2.5, -5, -5.5, 1.05, 1.05], 1, 20], 
    ['Marlon', [0.35, -1.5, -3, -3.5, 1.05, 1.05], 1, 20], 
    ['Tito', [0.25, -6.5, -6, -6.5, 1.05, 1.05], 0.5, 20], 
    ['Michael', [0.45, -4.5, -8, -8.5, 1.05, 1.05], 0.5, 20], 
    ['Randy', [0.65, -2.5, -4, -4.5, 1.05, 1.05], 0.5, 20], 
    ['Jackie', [0.55, -2.0, -3, -3.5, 1.05, 1.05], 0.75, 20], 
    ['Janet', [0.15, -1.5, -3.5, -4.0, 1.05, 1.05], 0.75, 20], 
    ['La Toya', [0.55, -1.5, -2.5, -3.0, 1.05, 1.05], 0.75, 20],
    ['Barry', [0.55, -2.0, -3, -3.5, 1.05, 1.05], 0.75, 20], 
    ['Robin', [0.15, -1.5, -3.5, -4.0, 1.05, 1.05], 0.75, 20], 
    ['Maurice', [0.55, -1.5, -2.5, -3.0, 1.05, 1.05], 0.75, 20],
    ['Donald', [1.0, -1.0, -5, -5.5, 1.05, 1.05], 0.25, 20],
    ['Ivana', [2.0, -2.0, -2, -2.5, 1.05, 1.05], 0.5, 20],
    ['Donald Jr', [1.0, -1.0, -7.0, -7.5, 1.05, 1.05], 0.3, 20],
    ['Eric', [1.0, -1.0, -5, -5.5, 1.05, 1.05], 0.25, 20],
    ['Ivanka', [2.0, -2.0, -2, -2.5, 1.05, 1.05], 0.1, 20],
    ['Jared', [3.0, -3.0, -2, -2.5, 1.05, 1.05], 0.2, 20],
    ['Marla', [3.0, -3.0, -1, -1.5, 1.05, 1.05], 0.5, 20],
    ['Tiffany', [2.0, -2.0, -1, -1.5, 1.05, 1.05], 0.5, 20],
    ['Melania', [1.0, -1.0, -1, -1.5, 1.05, 1.05], 0.5, 20],
    ['Barron', [1.0, -1.0, -1, -1.5, 1.05, 1.05], 0.5, 20],
    ['Index', [0, 0, -1.0, -1, -1, 1.05, 1.05], 1, 20],
  ],
};

module.exports = traderLists;
